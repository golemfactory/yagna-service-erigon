# yagna-service-erigon requestor

Requestor application for ordering erigons with a web interface.

This is the documentation of the requestor code. General documentation of the `yagna-service-erigon` project is [here](https://github.com/golemfactory/yagna-service-erigon#readme).
...
All requests must contain a header {'Authorization': 'Bearer [ETHEREUM\_ADDRESS]'}
